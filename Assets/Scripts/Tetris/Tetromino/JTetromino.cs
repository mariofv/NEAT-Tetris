...
public class JTetromino : Tetromino
{
    ...
    protected override void startAux()
    {
        ...
        shapes[0] = new Block.BlockType[][]{
           new Block.BlockType[]{ Block.BlockType.NONE,      Block.BlockType.NONE, Block.BlockType.J },
           new Block.BlockType[]{ Block.BlockType.J,     Block.BlockType.J,    Block.BlockType.J },
           new Block.BlockType[]{ Block.BlockType.NONE,  Block.BlockType.NONE, Block.BlockType.NONE }
        };
        shapes[1] = new Block.BlockType[][]{
            new Block.BlockType[]{ Block.BlockType.J, Block.BlockType.J, Block.BlockType.NONE },
            new Block.BlockType[]{ Block.BlockType.NONE, Block.BlockType.J, Block.BlockType.NONE },
            new Block.BlockType[]{ Block.BlockType.NONE, Block.BlockType.J, Block.BlockType.NONE }
        };
        shapes[2] = new Block.BlockType[][]{
            new Block.BlockType[]{ Block.BlockType.NONE, Block.BlockType.NONE, Block.BlockType.NONE },
            new Block.BlockType[]{ Block.BlockType.J,    Block.BlockType.J,    Block.BlockType.J },
            new Block.BlockType[]{ Block.BlockType.J, Block.BlockType.NONE, Block.BlockType.NONE }
        };
        shapes[3] = new Block.BlockType[][]{
            new Block.BlockType[]{ Block.BlockType.NONE, Block.BlockType.J, Block.BlockType.NONE },
            new Block.BlockType[]{ Block.BlockType.NONE, Block.BlockType.J, Block.BlockType.NONE },
            new Block.BlockType[]{ Block.BlockType.NONE,    Block.BlockType.J, Block.BlockType.J }
        };
    }
