...
public class LTetromino : Tetromino
{
    ...
    protected override void startAux()
    {
        ...
        shapes[0] = new Block.BlockType[][]{
            new Block.BlockType[]{ Block.BlockType.L, Block.BlockType.NONE, Block.BlockType.NONE },
            new Block.BlockType[]{ Block.BlockType.L,    Block.BlockType.L,    Block.BlockType.L },
            new Block.BlockType[]{ Block.BlockType.NONE, Block.BlockType.NONE, Block.BlockType.NONE }
        };
        shapes[1] = new Block.BlockType[][]{
            new Block.BlockType[]{ Block.BlockType.NONE, Block.BlockType.L, Block.BlockType.NONE },
            new Block.BlockType[]{ Block.BlockType.NONE, Block.BlockType.L, Block.BlockType.NONE },
            new Block.BlockType[]{ Block.BlockType.L, Block.BlockType.L, Block.BlockType.NONE }
        };
        shapes[2] = new Block.BlockType[][]{
            new Block.BlockType[]{ Block.BlockType.NONE, Block.BlockType.NONE, Block.BlockType.NONE},
            new Block.BlockType[]{ Block.BlockType.L,    Block.BlockType.L,    Block.BlockType.L},
            new Block.BlockType[]{ Block.BlockType.NONE,    Block.BlockType.NONE, Block.BlockType.L }
        };
        shapes[3] = new Block.BlockType[][]{
            new Block.BlockType[]{ Block.BlockType.NONE,    Block.BlockType.L, Block.BlockType.L },
            new Block.BlockType[]{ Block.BlockType.NONE, Block.BlockType.L, Block.BlockType.NONE },
            new Block.BlockType[]{ Block.BlockType.NONE, Block.BlockType.L, Block.BlockType.NONE }
        };
    }
